...
public class SendOTPPostprocessorKMS implements DataPostProcessor2 {

	private static final Logger LOG = LogManager
			.getLogger(com.hid.smsdelivery.postprocessor.SendOTPPostprocessorKMS.class);

	@Override
	public Object execute(Result result, DataControllerRequest request, DataControllerResponse response)
			throws Exception {

		LOG.debug("HID : Inside SendOTPPostprocessorKMS");
